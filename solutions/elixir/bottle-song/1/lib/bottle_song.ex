defmodule BottleSong do
  ...
  @spec start(pos_integer) :: [String.t()]
  defp start(bottle) do
    String.split(song(), "\n\n")
    |> Enum.slice(10 - bottle,  bottle)
  end

  @spec take_down([String.t()], pos_integer) :: String.t()
  defp take_down(selection, take_down) do
    selection
    |> Enum.take(take_down)
    |> Enum.join("\n\n")
    end
