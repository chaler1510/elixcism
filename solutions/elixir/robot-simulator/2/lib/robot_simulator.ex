defmodule RobotSimulator do
  ...
  def simulate({:error, _} = error, _), do: error
  def simulate(%Robot{} = robot, ""), do: robot

  def simulate(%Robot{} = robot, <<char, rest::binary>>) do
